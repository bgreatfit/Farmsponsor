                ...
                <div class="row">
                    <div class="col-md-6 col-12 col-sm-6">
                        <div class="transaction__card">
                            ...
                            <p class="card__text">{{Auth::user()->cyclesSponsored->count()}}</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12 col-sm-6">
                        <div class="transaction__card">
                        <a href="{{url('/dashboard/transaction-details')}}" class="card__heading transaction-history">Transaction History</a>
                        </div>
                    </div>
                </div>
            </div>
