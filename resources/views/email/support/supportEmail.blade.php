                                                ...
                                                <tr>
                                                    <td align="center" valign="top" class="introductionContentCell">
                                                        ...
                                                        <div class="introductionHeading">
                                                            <h1 class="introductionHeadingMain">Support Email</h1>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" class="customerInfoContent">
                                           <div>
                                               <br><br>
                                               Hello, {{$name}}, <br>
                                               Your message has been received and will be attended to by one of our support agents
                                               <br><br><br>
                                           </div>
                                        </td>
                                    </tr>
